...
COLUMNS = [
    ...
    ("vetting", "the employer check: safe | caution | avoid, set by --vet"),
    ("vetted_as", "who the check found the employer to be"),
    ("vetting_why", "the check's one-line reason"),
    ("vetted_on", "when it was checked"),
    ("location", ""),
